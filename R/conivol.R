...
#'   \item \code{\link[conivol]{polyh_samp_ivols_gen}} / \code{\link[conivol]{polyh_samp_ivols_ineq}}:
...
#'                      produces samples from the bivariate chi-bar-squared distribution
...
#'   \item \code{\link[conivol]{find_ivols_jags}} / \code{\link[conivol]{find_ivols_stan}}:
