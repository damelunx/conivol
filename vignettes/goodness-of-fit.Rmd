...
## The modified bivariate chi-bar-squared distribution {#link_mod_bivchibarsq}

[Recall](estim-conic-intrinsic-volumes-with-EM.html#link_setup) that we assumed to have sampled data: $(X_1,Y_1),\ldots,(X_N,Y_N)$ denote iid copies of $(X,Y)$ and we assume that they took the sample values $(x_1,y_1),\ldots,(x_N,y_N)$. Furthermore, we defined the two proportions
