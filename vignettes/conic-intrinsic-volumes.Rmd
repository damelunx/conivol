...
\begin{align*}
   \sum_{k=0}^d k^2 v_k(C) & \stackrel{?}{\leq}
   \sum_{k=0}^d k^2 v_k(\text{Circ}_d(\beta)) ,
\\ \sum_{k=0}^d -\log(v_k(C)) v_k(C) & \stackrel{?}{\leq}
   \sum_{k=0}^d -\log(v_k(\text{Circ}_d(\beta))) v_k(\text{Circ}_d(\beta)) .
\end{align*}
