...
```{r start-V-disp, fig.width=7, fig.align="center", echo=FALSE}
...
### No enforced parity or log-concavity {#no_enf_par_logc}
...
### Enforced parity equation {#enf_par}
...
```{r prior-iv-noninf, fig.width=7, fig.align="center", echo=FALSE}
...
```{r prior-iv-inf, fig.width=7, fig.align="center", echo=FALSE}
# we use the built-in function; by providing zero weights the posterior will equal the prior
...
### Enforced log-concavity {#enf_logc}
...
**Noninformative:**
```{r prior-iv-noninf-logc, fig.width=7, fig.align="center", echo=FALSE}
# construct matrix T
T <- matrix(0,d+1,d+1)
for (k in 0:(d-2)) {
    T[k+1,k+1] <- 1
...
**Informative:**
```{r prior-iv-inf-logc, fig.width=7, fig.align="center", echo=FALSE}
S_samp <- matrix(0,d+1,N)
for (k in 0:d)
...
## Posterior for intrinsic volumes data {#post_ivol}
...
```{r disp-d, echo=FALSE, fig.align="center"}
...
### Enforced parity equation {#post_enf_par}
...
```{r disp-dp, echo=FALSE, fig.align="center"}
...
```{r dir-enf-par-sm-noninf-comp, eval=FALSE}
post_iv <- polyh_bayes(samp_iv_sm,dimC,linC,v_prior=v0_iv_sm,prior_sample_size=1)
str(post_iv)
```
```{r dir-enf-par-sm-noninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/dir-enf-par-sm-noninf-1_save.png", dpi=100)
```
<!-- ```{r dir-enf-par-sm-noninf, fig.width=7, fig.align="center", echo=FALSE} -->
...
```{r dir-enf-par-sm-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/dir-enf-par-sm-inf-1_save.png", dpi=100)
```
<!-- ```{r dir-enf-par-sm-inf, fig.width=7, fig.align="center", echo=FALSE} -->
...
```{r dir-enf-par-la-noninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/dir-enf-par-la-noninf-1_save.png", dpi=100)
```
<!-- ```{r dir-enf-par-la-noninf, fig.width=7, fig.align="center", echo=FALSE} -->
...
```{r dir-enf-par-la-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/dir-enf-par-la-inf-1_save.png", dpi=100)
```
<!-- ```{r dir-enf-par-la-inf, fig.width=7, fig.align="center", echo=FALSE} -->
...
### Enforced log-concavity {#post_enf_logc}
...
graphical model:  
```{r disp-dl, fig.align="center", echo=FALSE}
...
**Small sample, noninformative prior:**  
Define Stan model:
```{r dir-enf-logc-comp, warning=FALSE, eval=FALSE}
...
```
Run Stan model:
```{r dir-enf-logc-comp2, fig.width=7, fig.align="center", warning=FALSE, eval=FALSE}
stanfit <- stan( file = filename, data = staninp$data, chains = 1,
                 warmup = 1000, iter = 2000, cores = 2, refresh = 1000 )
post_iv_logc <- rstan::extract(stanfit)$V[100*(1:10),]
```

```{r dir-enf-logc-sm-noninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/dir-enf-logc-sm-noninf-1_save.png", dpi=100)
```
<!-- ```{r dir-enf-logc-sm-noninf, fig.width=7, fig.align="center", echo=FALSE} -->
...
**Small sample, informative prior:**
```{r dir-enf-logc-sm-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/dir-enf-logc-sm-inf-1_save.png", dpi=100)
```
<!-- ```{r dir-enf-logc-sm-inf, fig.width=7, fig.align="center", echo=FALSE, warning=FALSE} -->
...
**Large sample, noninformative prior:**
```{r dir-enf-logc-la-noninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/dir-enf-logc-la-noninf-1_save.png", dpi=100)
```
<!-- ```{r dir-enf-logc-la-noninf, fig.width=7, fig.align="center", echo=FALSE, warning=FALSE} -->
<!-- # obtain Stan input (model already defined) -->
...
**Large sample, informative prior:**
```{r dir-enf-logc-la-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/dir-enf-logc-la-inf-1_save.png", dpi=100)
```
<!-- ```{r dir-enf-logc-la-inf, fig.width=7, fig.align="center", echo=FALSE, warning=FALSE} -->
<!-- # obtain Stan input (model already defined) -->
<!-- staninp <- polyh_stan(samp_iv_la, dimC, linC, -->
...
```{r disp-id, echo=FALSE, fig.align="center"}
include_graphics(img_paths$id, dpi=img_dpi)
```


### Enforced parity {#bcb_enf_par}
...
$d$ even:  
```{r disp-idpe, echo=FALSE, fig.align="center"}
include_graphics(img_paths$idpe, dpi=img_dpi)
```

$d$ odd:  
```{r disp-idpo, echo=FALSE, fig.align="center"}
...
```{r indir-JAGS-enf-par-sm-ninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-JAGS-enf-par-sm-ninf-1_save.png", dpi=100)
```
<!-- ```{r indir-JAGS-enf-par-sm-ninf, warning=FALSE, fig.width=7, fig.align="center"} -->
...
```{r indir-JAGS-enf-par-sm-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-JAGS-enf-par-sm-inf-1_save.png", dpi=100)
```
<!-- ```{r indir-JAGS-enf-par-sm-inf, warning=FALSE, fig.width=7, fig.align="center", echo=FALSE, warning=FALSE, results=FALSE} -->
<!-- # obtain input data for JAGS model -->
...
```{r indir-JAGS-enf-par-la-ninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-JAGS-enf-par-la-ninf-1_save.png", dpi=100)
```
<!-- ```{r indir-JAGS-enf-par-la-ninf, warning=FALSE, fig.width=7, fig.align="center", echo=FALSE, warning=FALSE, results=FALSE} -->
<!-- # obtain input data for JAGS model -->
...
```{r indir-JAGS-enf-par-la-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-JAGS-enf-par-la-inf-1_save.png", dpi=100)
```
<!-- ```{r indir-JAGS-enf-par-la-inf, warning=FALSE, fig.width=7, fig.align="center", echo=FALSE, warning=FALSE, results=FALSE} -->
<!-- # obtain input data for JAGS model -->
...
```{r indir-Stan-enf-par-sm-ninf-comp1, warning=FALSE, fig.width=7, fig.align="center", eval=FALSE}
filename <- "ex_stan_model_bcb.stan"
staninp <- estim_stan(samp_bcb_sm, d, dimC, linC,
                      v_prior=v0_bcb_sm, filename=filename)
```
```{r indir-Stan-enf-par-sm-ninf-comp1a, include=FALSE, eval=FALSE}
# this is so that some compiler warnings do not appear in the markdown
# (those warnings are only shown when running the Stan model the first time)
stanfit <- stan( file = filename, data = staninp$data, chains = 1,
                 warmup = 1, iter = 2, cores = 1, refresh = 10 )
```
```{r indir-Stan-enf-par-sm-ninf-comp2, warning=FALSE, fig.width=7, fig.align="center", eval=FALSE}
stanfit <- stan( file = filename, data = staninp$data, chains = 1,
                 warmup = 1000, iter = 2000, cores = 2, refresh = 1000 )
post_bcb_pa <- rstan::extract(stanfit)$V[100*(1:10),]
```
```{r indir-Stan-enf-par-sm-ninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-Stan-enf-par-sm-ninf-1_save.png", dpi=100)
```
<!-- ```{r indir-Stan-enf-par-sm-ninf, fig.width=7, fig.align="center", echo=FALSE} -->
<!-- tib_plot <- t(post_bcb_pa) %>% -->
<!--     as_tibble() %>% add_column(k=linC:dimC, .before=1) %>% -->
<!--     gather(key,value,2:(N+1)) -->
<!-- ggplot(tib_plot, aes(x=k, y=(value), color=key)) + -->
...
```{r indir-Stan-enf-par-sm-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-Stan-enf-par-sm-inf-1_save.png", dpi=100)
```
<!-- ```{r indir-Stan-enf-par-sm-inf, warning=FALSE, fig.width=7, fig.align="center", echo=FALSE} -->
<!-- # obtain Stan input (model already defined) -->
...
```{r indir-Stan-enf-par-la-ninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-Stan-enf-par-la-ninf-1_save.png", dpi=100)
```
<!-- ```{r indir-Stan-enf-par-la-ninf, warning=FALSE, fig.width=7, fig.align="center", echo=FALSE} -->
<!-- # obtain Stan input (model already defined) -->
...
```{r indir-Stan-enf-par-la-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-Stan-enf-par-la-inf-1_save.png", dpi=100)
```
<!-- ```{r indir-Stan-enf-par-la-inf, warning=FALSE, fig.width=7, fig.align="center", echo=FALSE} -->
<!-- # obtain Stan input (model already defined) -->
...
### Enforced log-concavity {#bcb_enf_logc}
...
$d$ even:  
```{r disp-idle, echo=FALSE, fig.align="center"}
include_graphics(img_paths$idle, dpi=img_dpi)
```

$d$ odd:  
```{r disp-idlo, echo=FALSE, fig.align="center"}
...
**Small sample, noninformative prior:**  
```{r indir-Stan-enf-logc-sm-ninf-comp1, warning=FALSE, fig.width=7, fig.align="center", eval=FALSE}
filename <- "ex_stan_model_bcb_logc.stan"
staninp <- estim_stan(samp_bcb_sm, d, dimC, linC, enforce_logconc=TRUE,
                      v_prior=v0_bcb_sm, filename=filename)
```
```{r indir-Stan-enf-logc-sm-ninf-comp1a, include=FALSE, eval=FALSE}
# this is so that some compiler warnings do not appear in the markdown
# (those warnings are only shown when running the Stan model the first time)
stanfit <- stan( file = filename, data = staninp$data, chains = 1,
                 warmup = 1, iter = 2, cores = 1, refresh = 10 )
```
```{r indir-Stan-enf-logc-sm-ninf-comp2, warning=FALSE, fig.width=7, fig.align="center", eval=FALSE}
stanfit <- stan( file = filename, data = staninp$data, chains = 1,
                 warmup = 1000, iter = 2000, cores = 2, refresh = 1000 )
post_bcb_logc <- rstan::extract(stanfit)$V[100*(1:10),]
```
```{r indir-Stan-enf-logc-sm-ninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-Stan-enf-logc-sm-ninf-1_save.png", dpi=100)
```
<!-- ```{r indir-Stan-enf-logc-sm-ninf, fig.width=7, fig.align="center", echo=FALSE} -->
...
**Small sample, informative prior:**  
```{r indir-Stan-enf-logc-sm-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-Stan-enf-logc-sm-inf-1_save.png", dpi=100)
```
<!-- ```{r indir-Stan-enf-logc-sm-inf, warning=FALSE, fig.width=7, fig.align="center", echo=FALSE} -->
<!-- # obtain Stan input (model already defined) -->
<!-- staninp <- estim_stan(samp_bcb_sm, d, dimC, linC, enforce_logconc=TRUE, -->
...
**Large sample, noninformative prior:**  
```{r indir-Stan-enf-logc-la-ninf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-Stan-enf-logc-la-ninf-1_save.png", dpi=100)
```
<!-- ```{r indir-Stan-enf-logc-la-ninf, warning=FALSE, fig.width=7, fig.align="center", echo=FALSE} -->
<!-- # obtain Stan input (model already defined) -->
...
**Large sample, informative prior:**  
```{r indir-Stan-enf-logc-la-inf, echo=FALSE, fig.align="center"}
include_graphics("bayesian_figures/indir-Stan-enf-logc-la-inf-1_save.png", dpi=100)
```
<!-- ```{r indir-Stan-enf-logc-la-inf, warning=FALSE, fig.width=7, fig.align="center", echo=FALSE} -->
<!-- # obtain Stan input (model already defined) -->
<!-- staninp <- estim_stan(samp_bcb_la, d, dimC, linC, enforce_logconc=TRUE, -->
